...
public partial class Admin_Category : System.Web.UI.Page
{
    ...
    MainDataSetTableAdapters.SubCategoryTableAdapter SubCategoryTbl = new MainDataSetTableAdapters.SubCategoryTableAdapter();
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
       ...
       (SubCategoryTbl.SubCategory_Select_By_CatID(Convert.ToInt32(txtCatID.Text)).Rows.Count > 0)
        {
